        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 text-center lg:text-left">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl">
              Automate timetable generation, balance faculty workload, and maximize resource utilization 
              with our intelligent dashboard designed for educational institutions.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Link to="/signup">
                <Button size="lg" className="bg-gradient-primary hover:opacity-90 text-primary-foreground shadow-lg hover:shadow-glow transition-all duration-300">
                  Get Started
